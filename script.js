...
//methods chaining - add return this to the individual methods
acc1.deposit(1000).deposit(200).requestLoan(30000).withdraw(25000);
console.log(acc1.getMovements());
...
rivian.chargeBattery(80).brake().accelerate();
